...
export async function GET(rawrequest:NextRequest) {
  ...
  return new ImageResponse(
    (
<div id="rerere" className={style.$1}
    style={{backgroundImage: "linear-gradient(rgba(31, 150, 231, 0.8), rgba(72, 106, 231, 0.8)), url('/polygon.png')"}}>
    <div className={style.ResultScreen_container}>
        <div className={style.Track}>
            ...
            <div className={`${style.Track_difficulty} ${style["Track_difficulty-hard"]}`}> HARD </div>
        </div>
        <div className={style.Score}>
            <div className={style.Score_label}>Score</div>
            <div className={style.Score_value}>846413</div>
            <div className={`${style.Score_diff} ${style["ng-star-inserted"]}`}>[ -054932 ]</div>
        </div>
        ...
        <div className={style.Detail}>
            ...
            <div className={style.Average}>
                <div className={style.Average_value} style={{bottom: "38.9732%"}}> -11.027ms </div>
            </div>
            <div className={style.Detail_table}>
                <div className={style.Detail_table_row}>
        ...
        <div className={`${style.Publish} ${style["ng-star-inserted"]}`}>タイムラインに投稿</div>
